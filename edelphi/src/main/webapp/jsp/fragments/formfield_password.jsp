...
<c:set var="classes">formField formPasswordField</c:set>
<c:choose>
...
<div class="formFieldContainer formPasswordFieldContainer">
  <c:choose>
  ...
  <input type="password" name="${param.name}" class="${classes}" value="${param.value}"/>
</div>