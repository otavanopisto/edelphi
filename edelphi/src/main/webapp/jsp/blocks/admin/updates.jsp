...
<div class="block">
  ...
  <!-- TODO: Locale and functionality -->

  <jsp:include page="/jsp/fragments/block_title.jsp">
    <jsp:param value="panel.block.updatesTitle" name="titleLocale"/>
  </jsp:include>
  
  <div id="panelUpdatesBlockContent" class="blockContent">
  
    <div class="panelUpdateRow">
      <div class="panelGenericTitle">Paneelin tiedote päivitys juttu</div>
    ...
    <div class="panelSystemUpdateRow">
      <div class="panelGenericTitle">Järjestelmän runoilema paneelin päivitys juttu</div>
      <div class="panelGenericMeta">Maaliskuu 3, 2011 klo. 13:09</div>
      <div class="contextualLinks">
        <jsp:include page="/jsp/fragments/contextual_link.jsp">
          <jsp:param name="onclick" value="" />
