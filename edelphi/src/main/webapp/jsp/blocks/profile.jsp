...
<div class="block">
  ...
  <jsp:include page="/jsp/fragments/block_title.jsp">
    ...
    <div class="profilePictureWrapper">
      <div class="profilePictureTitle"><fmt:message key="profile.block.profilePictureBlockTitle"/></div>
	    <div id="profilePicture" class="profilePicture" style="${userPictureStyle}">
	      <div class="changeProfilePictureButton"><fmt:message key="profile.block.profilePicture.changeProfilePictureButton"/></div>
	      ...
	      <div class="changeProfilePictureModalContainer" style="display: none">
	        <iframe id="_uploadFrame" onload="profilePictureSelected('${pageContext.request.contextPath}/user/picture.binary?userId=${user.id}');" style="display: none" name="_uploadFrame">
	        </iframe>
  ...
  <c:if test="${authCount gt credentialAuthCount}">
    ...
    <div id="profileExternalAuthBlockContent" class="blockContent">
        ...
        <c:choose>
            ...
            <div class="profileExternalAuthLoginTypeIcon loginType${authSource.strategy}">${authSource.name}  <span class="loginTypeInUseTextContainer"><fmt:message key="profile.block.loginType.activated"/></span></div>
  	      </c:when>
  	      <c:otherwise>
            <div class="profileExternalAuthLoginTypeIcon loginType${authSource.strategy}">${authSource.name}  <a href="${pageContext.request.contextPath}/dologin.page?authSource=${authSource.id}"><fmt:message key="profile.block.loginType.activate"/></a></div>
  	      </c:otherwise>
  	    </c:choose>
  	  </c:forEach>
    </div>
