...
<html>
  ...
  <body class="environment_admin index">
    ...
    <jsp:include page="/jsp/templates/panel_header.jsp"></jsp:include>
    ...
    <div class="GUI_pageWrapper">
          ...
          <jsp:include page="/jsp/blocks/admin/managepaneltemplate.jsp">
            <jsp:param name="jsonHandler" value="${pageContext.request.contextPath}/admin/savepaneltemplate.json"/>
          </jsp:include>
