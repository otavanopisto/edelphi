...
<html>
  ...
  <body class="panel_admin">
    ...
    <c:set var="pageBreadcrumbTitle"><fmt:message key="breadcrumb.panelAdmin.queryResults"/></c:set>
    ...
    <jsp:include page="/jsp/templates/panel_header.jsp">
      ...
      <jsp:param value="${pageContext.request.contextPath}/panel/admin/queryresults.page?panelId=${panel.id}" name="breadcrumbPageUrl"/>
    </jsp:include>
